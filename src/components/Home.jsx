          ...
          <>
            ...
            <div className="flex flex-col items-center text-center space-y-6 mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl">
                Para que un territorio sea seguro no debe de existir peligros no identificados de esta manera aseguramos un ambiente de trabajo seguro garantizando que no ocurran accidentes.
              </p>
              <button
              ...
              {[
                {
                  ...
                  description: 'Reportar peligros garantizando las 5s para la organización y seguridad del trabajo.'
                },
                {
                  title: 'Cultura',
                  icon: <Shield className="w-6 h-6" />,
                  description: 'Fomentamos una cultura de seguridad en todos los niveles.'
                },
                {
                  title: 'Gestión SIF',
                  icon: <AlertTriangle className="w-6 h-6" />,
                  description: 'Sistema Integral de Fatalidades para prevenir accidentes graves.'
                }
              ].map((item, index) => (
                <div key={index} className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10">
            ...
            <section className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                  <h4 className="text-xl font-semibold mb-3">¿Que es un peligro?</h4>
                  <p className="text-gray-400">Un peligro es cualquier situación, condición o elemento que tiene el potencial de causar daño, lesión o afectación a las personas, al ambiente o a los bienes materiales.</p>
                </div>
                <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                  <h4 className="text-xl font-semibold mb-3">¿Para que reportamos los peligros?</h4>
                  <p className="text-gray-400">Reportamos un peligro para prevenir accidentes y reducir riesgos, protegiendo así la seguridad de los trabajadores, la integridad de los equipos y el cumplimiento de normas de seguridad.</p>
                </div>
              </div>
